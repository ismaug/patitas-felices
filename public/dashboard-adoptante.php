<?php
/**
 * Dashboard del Adoptante - Sistema Patitas Felices
 * Dashboard específico con funcionalidades para el rol de Adoptante
 */
...
// Obtener datos específicos del Adoptante
try {
...
<head>
    ...
    <title>Dashboard Adoptante - Patitas Felices</title>
    ...
    <style>
        ...
        /* Colores específicos para Adoptante */
...
<body>
    ...
    <header class="dashboard-header">
        <div class="header-left">
            <a href="dashboard-adoptante.php" class="logo-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="dashboard-adoptante.php" class="nav-item active">
        ...
        <main class="main-content" id="mainContent">
            ...
            <div class="welcome-section">
                ...
                <p class="welcome-subtitle">
                    Bienvenido a Patitas Felices. Encuentra a tu compañero perfecto.
                </p>
            </div>
            ...
            <div class="actions-section">
                ...
                <div class="actions-grid">
                    <a href="catalogo_animales.php" class="action-card">
                        ...
                        <p class="action-description">Descubre todos los animales disponibles para adopción y encuentra a tu compañero perfecto (CU-04).</p>
                    </a>
                    ...
                    <a href="mis_solicitudes.php" class="action-card">
                        ...
                        <p class="action-description">Revisa el estado de tus solicitudes de adopción y los próximos pasos (CU-09).</p>
                    </a>
                    ...
                    <a href="actividades_voluntariado.php" class="action-card">
                        ...
                        <p class="action-description">Participa en actividades de voluntariado y contribuye al bienestar de los animales (CU-11).</p>
                    </a>
